const INIT_LEADS = [
  ...
  { id: 'LD-215', pipeline: 'B2C', leadName: 'Ramesh Nair — 100 Mbps Home', name: 'Ramesh Nair', phone: '9876001890', email: 'ramesh.nair@email.com', area: 'Koramangala', source: 'Website', stage: 'Installation Visit', plan: '100 Mbps Home', assigned: 'Arjun Kumar', assignedInitials: 'AK', assignedColor: 'bg-brand-blue', daysInStage: 1, lastActivity: 'Moved to Installation Visit', followUp: '', priority: 'high', ekycStatus: 'Completed', hwAssigned: null, createdAt: '2026-05-21', address: '12, Brigade Road', city: 'Bangalore', pincode: '560001', alternateMobile: '9812345678', createdBy: 'Arjun Kumar', kycDocs: { aadhaar: 'aadhaar_ramesh.pdf', panCard: 'pan_ramesh.pdf', customerPhoto: 'photo_ramesh.jpg' }, stageHistory: [
