...
const INIT_PIPELINES = [
  {
    ...
    stages: [
      ...
      { id: 's4',  name: 'Feasibility',        color: 'bg-amber-500',   required: false, type: 'Standard', active: true, statusType: 'Open', followUpAllowed: true  },
      { id: 's5d', name: 'Installation Visit', color: 'bg-orange-500',  required: false, type: 'Standard', active: true, statusType: 'Open', followUpAllowed: true  },
