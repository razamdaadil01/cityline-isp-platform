...
let _plans = [
  ...
  { id: 16, name: 'Static IP Add-on',        serviceType: 'Other Package', server: '',          serverType: '',          packageType: 'Public',  billingType: 'Monthly',       price: 500,   speed: '',         validity: 30,  ottBundle: false, offer: false, status: 'active',   sortOrder: 1,  noOfRecharge: 1,  subPlanName: '',              bwPackageId: '',        createdAt: '2025-01-10', addedBy: 'Admin' },
  { id: 17, name: 'Router Rental',           serviceType: 'Other Package', server: '',          serverType: '',          packageType: 'Public',  billingType: 'Monthly',       price: 299,   speed: '',         validity: 30,  ottBundle: false, offer: false, status: 'active',   sortOrder: 2,  noOfRecharge: 1,  subPlanName: '',              bwPackageId: '',        createdAt: '2025-01-10', addedBy: 'Admin' },
  { id: 18, name: 'Installation Charges',    serviceType: 'Other Package', server: '',          serverType: '',          packageType: 'Public',  billingType: 'One Time',      price: 1500,  speed: '',         validity: null, ottBundle: false, offer: false, status: 'active',   sortOrder: 3,  noOfRecharge: 1,  subPlanName: '',              bwPackageId: '',        createdAt: '2025-01-10', addedBy: 'Admin' },
  { id: 19, name: 'Security Deposit',        serviceType: 'Other Package', server: '',          serverType: '',          packageType: 'Public',  billingType: 'One Time',      price: 2000,  speed: '',         validity: null, ottBundle: false, offer: false, status: 'active',   sortOrder: 4,  noOfRecharge: 1,  subPlanName: '',              bwPackageId: '',        createdAt: '2025-01-10', addedBy: 'Admin' },
  { id: 20, name: 'ONU Device Charge',       serviceType: 'Other Package', server: '',          serverType: '',          packageType: 'Public',  billingType: 'One Time',      price: 800,   speed: '',         validity: null, ottBundle: false, offer: false, status: 'inactive', sortOrder: 5,  noOfRecharge: 1,  subPlanName: '',              bwPackageId: '',        createdAt: '2025-01-10', addedBy: 'Admin' },
]
