const INIT_FOLLOWUPS = [
  {
    id: 'FU-001', leadId: 'LD-201', leadName: 'Ramesh Nair',      customer: 'Ramesh Nair',          pipeline: 'Residential', phone: '9876001122',
  ...
  {
    id: 'FU-002', leadId: 'LD-202', leadName: 'Sunita Bose',      customer: 'Sunita Bose',          pipeline: 'Residential', phone: '9765443322',
    date: '2026-05-09', time: '11:30', note: 'Send quotation after call',
    stage: 'Follow-up', assignedTo: 'Preethi Nair', notifyTo: [],
    priority: 'high', status: 'Overdue',
  },
  {
    id: 'FU-003', leadId: 'LD-205', leadName: 'Deepak Joshi',     customer: 'Deepak Joshi',         pipeline: 'Residential', phone: '9011556677',
  ...
  {
    id: 'FU-004', leadId: 'LD-204', leadName: 'Meena Iyer',       customer: 'Meena Iyer',           pipeline: 'Residential', phone: '9123887766',
  ...
  {
    id: 'FU-005', leadId: 'LD-210', leadName: 'Rekha Menon',      customer: 'Rekha Menon',          pipeline: 'Residential', phone: '9871234560',
    date: '2026-05-16', time: '10:30', note: 'Share 500 Mbps plan details',
    stage: 'Contacted', assignedTo: 'Anita Sharma', notifyTo: [],
    priority: 'high', status: 'Pending',
  },
  {
    id: 'FU-006', leadId: 'LD-211', leadName: 'Sanjay Rao',       customer: 'Sanjay Tech Solutions', pipeline: 'Corporate',   phone: '9654321098',
    date: '2026-05-18', time: '09:00', note: 'Site survey scheduled',
    stage: 'Site Survey', assignedTo: 'Arjun Kumar', notifyTo: ['Suresh Babu'],
    priority: 'medium', status: 'Pending',
  },
  {
    id: 'FU-007', leadId: 'LD-206', leadName: 'Kavita Sharma',    customer: 'Kavita Sharma',        pipeline: 'Residential', phone: '9876543210',
    date: '2026-05-20', time: '12:00', note: 'Check if quote was reviewed',
    stage: 'Quotation Sent', assignedTo: 'Anita Sharma', notifyTo: [],
    priority: 'medium', status: 'Pending',
  },
  {
    id: 'FU-008', leadId: 'LD-213', leadName: 'Mohan Das',        customer: 'Mohan Das',            pipeline: 'Residential', phone: '9345678901',
    date: '2026-05-22', time: '11:00', note: 'Follow up on walk-in visit',
    stage: 'New Inquiry', assignedTo: 'Suresh Babu', notifyTo: [],
    priority: 'low', status: 'Pending',
  },
  {
    id: 'FU-009', leadId: 'LD-203', leadName: 'Harish Kulkarni',  customer: 'Kulkarni Enterprises', pipeline: 'Corporate',   phone: '9988001133',
    date: '2026-05-25', time: '15:30', note: 'Post-survey proposal discussion',
    stage: 'Site Survey', assignedTo: 'Arjun Kumar', notifyTo: [],
    priority: 'medium', status: 'Pending',
  },
  {
    id: 'FU-010', leadId: 'LD-201', leadName: 'Ramesh Nair',      customer: 'Ramesh Nair',          pipeline: 'Residential', phone: '9876001122',
