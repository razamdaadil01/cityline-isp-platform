...
const INIT_INSTALLATIONS = [
  { id: 'IWO-2026-0001', customer: 'Mohan Das',    customerId: 'IC-CUST-2026-000001', phone: '93456 78901', circuitId: 'IC-2026-0001', zone: 'Andheri West', engineer: 'Suresh Babu',   installDate: '20-06-2026', installTime: '10:00', createdDate: '18-06-2026', completedDate: '20-06-2026', notes: 'Standard intercom installation', status: 'completed'  },
  { id: 'IWO-2026-0002', customer: 'Priya Nair',   customerId: 'IC-CUST-2026-000002', phone: '98765 43210', circuitId: 'IC-2026-0002', zone: 'Bandra East',  engineer: 'Arjun Kumar',   installDate: '22-06-2026', installTime: '11:00', createdDate: '20-06-2026', completedDate: '22-06-2026', notes: 'Plus plan installation with extended handset range', status: 'completed'  },
