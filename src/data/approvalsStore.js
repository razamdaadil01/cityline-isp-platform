...
const SEED = [
  ...
  },
  {
    ...
    type: 'Purchase Order',
    status: 'Pending',
    relatedType: 'purchase-order', relatedId: 'PO-000006', relatedLabel: 'CITY/PO/2026/00006',
    requestedBy: 'Anita Sharma',
    requestedDate: new Date(NOW - 6 * H).toISOString(),
    amount: 42126,
    purchaseOrder: { poId: 'PO-000006', poNumber: 'CITY/PO/2026/00006', vendorName: 'TP-Link India Pvt Ltd', storeName: 'Andheri Store' },
    items: [{ name: 'POE Switch', quantity: 6, unitPrice: 2200 }, { name: 'WiFi Router', quantity: 15, unitPrice: 1500 }],
  },
  {
    id: 'APR-2026-000013',
    type: 'Purchase Order',
    status: 'Correction Required',
    relatedType: 'purchase-order', relatedId: 'PO-000007', relatedLabel: 'CLF/PO/2026/00002',
    requestedBy: 'Salim Khan',
    requestedDate: new Date(NOW - 40 * H).toISOString(),
    amount: 38940,
    purchaseOrder: { poId: 'PO-000007', poNumber: 'CLF/PO/2026/00002', vendorName: 'Sterlite Technologies', storeName: 'Bandra Store' },
    items: [{ name: 'Optical Splitter 1x8', quantity: 30, unitPrice: 650 }, { name: 'SFP Module 1G', quantity: 15, unitPrice: 900 }],
    decidedBy: 'Admin User', decidedAt: new Date(NOW - 10 * H).toISOString(), decisionComment: 'Pricing on Optical Splitter 1x8 is above the last agreed rate — please renegotiate with the vendor and resend.',
  },
].map(a => ({
  ...a,
