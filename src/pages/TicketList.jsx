...
import {
  ...
  TICKET_STATUSES, CLOSED_STATUSES, PRIORITIES, PRIORITY_LABEL, CATEGORIES, AREAS, AGENTS, TECHNICIANS, OFFICE_TEAMS,
...
// ── Assign Team modal — Individual / Team tabs, independent multi-select ──
// (search + checkbox list + chips pattern matches Feasibility's Assign Engineer modal)

function AssignTeamModal({ open, onClose, ticket, onApply }) {
